...
test("validateScenarioDefinition rejects seeded live head branches that differ from scenario branch", () => {
  assert.throws(() => validateScenarioDefinition({
    id: "seeded-wrong-head",
    kind: "seeded",
    issueSlug: "seeded-wrong-head",
    branch: "scenario/seeded-wrong-head",
    baseBranch: "main",
    shipTargetBranch: "integration/live",
    expectedCiStatus: "passed",
    expectedReviewOutcome: "approved",
