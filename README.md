...
Managed AgentRail runners preserve CI provider wiring across pull request submission, so submitted PRs continue to report against the same configured checks.
