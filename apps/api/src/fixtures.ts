...
import { buildTaskSnapshot, buildTaskSummary as summarizeTaskSnapshots } from "../../../packages/task-engine/src/index.js";
...
export function buildTaskSummary(): TaskSummary {
  return summarizeTaskSnapshots(buildTaskSnapshots());
}
